...
% KALMANGUI MATLAB code for KalmanGui.fig
...
%
%      KALMANGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in KALMANGUI.M with the given input arguments.
%
%      KALMANGUI('Property','Value',...) creates a new KALMANGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before KalmanGui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to KalmanGui_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 21-Sep-2017 20:06:18
...
% --- Executes just before KalmanGui is made visible.
function KalmanGui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to KalmanGui (see VARARGIN)
